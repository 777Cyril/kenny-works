  ...
  return (
    <section className="section-screen" id="hero" ref={ref}>
      <div className="max-w-2xl text-center">
        ...
        <h1
          className="font-serif-display text-5xl md:text-7xl lg:text-8xl leading-tight font-light reveal-text"
        ...
        >
          <p className="font-serif-display text-lg md:text-xl leading-relaxed text-gray-600">
            Bridging high culture and street-level desire.
